...
print(f"DEBUG - USER: {os.getenv('DB_USER')}")
...
SECRET_KEY = 'django-insecure-&t+r$noyqeb^2b-#r9%9sk=ouk&sp978_b(knnae$g$4*&grue'
...
WSGI_APPLICATION = 'SOS_Iguacu_Backend.wsgi.application'
