...
class RegiaoAfetadaModelTest(TestCase):
    ...
    def test_ordering(self):
        ...
        regioes_nivel_3 = RegiaoAfetada.objects.filter(nivel_prioridade=3).order_by('-nivel_prioridade', 'data_ocorrencia')
...
class DoacaoModelTest(TestCase):
    ...
    def test_doacao_defaults(self):
        """Verifica se os valores padrão são aplicados corretamente."""
        self.assertEqual(self.doacao_estoque.tipo, 'OUTRO', "O tipo default deve ser 'OUTRO'.")
